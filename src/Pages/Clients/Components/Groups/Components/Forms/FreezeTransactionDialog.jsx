...
const FreezeTransactionDialog = ({ isOpen, onClose, refetch }) => {
  const axiosPrivate = useAxiosPrivate();
  const { client_id: accountId } = useParams(); // ✅ Get client_id from params
    ...
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[350px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Select an action to freeze an amount.
          </DialogDescription>
          <DialogClose asChild>
            <button
...
export default FreezeTransactionDialog;
