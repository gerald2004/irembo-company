                ...
                {isLoading ? (
                  ...
                  <>
                    <Avatar
                      ...
                      onClick={
                        hasPermission(roles, 100152)
                          ? () => openFilePicker(profileInputRef)
                          : ""
                      }
                    >
                ...
                {isLoading ? (
                  ...
                  <>
                    <div
                      ...
                      onClick={
                        hasPermission(roles, 100153)
                          ? () => openFilePicker(signatureInputRef)
                          : ""
                      }
                    >
                      {data?.client_signature ? (
                ...
                {isLoading ? (
                  ...
                  <>
                    ...
                    <p>
                      ...
                      <span className="capitalize">{data?.client_gender}</span>
                    </p>
                    <p>
                      <span className="font-medium">Date of Birth:</span>{" "}
                      <span>
                        {formatDateTimestamp(data?.client_date_of_birth)}
                      </span>
                    </p>
                  </>
                )}
              ...
              <div className="space-y-10">
                {hasPermission(roles, 100009) && (
                  <Button
                    size="sm"
                    onClick={() =>
                      navigate(`/clients/individual/${id}/edit-client`)
                    }
                  >
                    Update
                  </Button>
              ...
              <>
                ...
                <div className="flex gap-x-4 items-center">
                  ...
                  <span className="w-2/3 capitalize">
                    {data?.client_martial_status || "None"}
                  </span>
                </div>
                <div className="flex gap-x-4 items-center">
                ...
                <div className="flex gap-x-4 items-center">
                  ...
                  <span className="w-2/3 capitalize">
                    {data?.client_employment_status}
                    <span className="text-xs capitalize mx-2">
                      (Gross Salary
                      {data?.client_employment_status === "employed"
                        ? parseFloat(
                            data.client_estimated_gross
                          ).toLocaleString()
                        : ""}
                      )
                    </span>
                ...
                <div className="flex gap-x-4 items-center">
                  ...
                  <span className="w-2/3">
                    {data?.client_identification || "None"}
                  </span>
                </div>
                ...
                <div className="flex gap-x-4 items-center">
                  ...
                  <span className="w-2/3">
                    {formatDateTimestamp(data?.client_date_of_birth) || "None"}
                  </span>
                </div>
                <div className="flex gap-x-4 items-center">
