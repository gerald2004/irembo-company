        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          {step === 1 && (
            <fieldset className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Deposit Amount */}
              <div>
                <Label htmlFor="deposit_transaction_amount">
                  Deposit Amount
                </Label>
                <Input
                  ...
                  {...register("deposit_transaction_amount", {
                    required: "Amount is required",
                  })}
                />
                {errors.deposit_transaction_amount && (
                  <p className="text-red-500 text-sm">
                    {errors.deposit_transaction_amount.message}
                  </p>
                )}
              </div>
              ...
              {/* Deposit Method */}
              <div>
                <Label htmlFor="deposit_transaction_method">
                  Deposit Method
                </Label>
                <Controller
                  name="deposit_transaction_method"
                  control={control}
                  rules={{ required: "Deposit method is required" }}
                  render={({ field }) => (
                    <Select
                ...
                />
                {errors.deposit_transaction_method && (
                  <p className="text-red-500 text-sm">
                    {errors.deposit_transaction_method.message}
                  </p>
                )}
              </div>
              <div>
                ...
                <Input
                  ...
                  {...register("deposit_transaction_notary", {
                    required: "Deposit Notary is required",
                  })}
                />
                {errors.deposit_transaction_notary && (
                  <p className="text-red-500 text-sm">
                    {errors.deposit_transaction_notary.message}
                  </p>
                )}
              </div>
              {/* Notes */}
              <div>
                <Label htmlFor="deposit_transaction_notes">
                  Notes (Optional)
                </Label>
                <Input
