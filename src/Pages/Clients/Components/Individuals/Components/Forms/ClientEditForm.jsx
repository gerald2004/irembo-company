...
const ClientEditForm = ({ defaultValues }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      reset();
      setStep(1);
      navigate(`/clients/individual/${id}`);
    } catch (error) {
      const errorMessage =
  ...
  useEffect(() => {
    if (defaultValues) {
      Object.keys(defaultValues).forEach((key) => {
        ...
        // ✅ Handle Date Fields without timezone shift
        if (key.includes("date") && typeof value === "string") {
          value = value.split("T")[0]; // Keep only YYYY-MM-DD part
        }
              ...
              <fieldset className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => {
                      const parsedDate = parseLocalDate(field.value);
                ...
                <div>
                  ...
                  <Controller
                    name="client_gender"
                    control={control}
                    defaultValue={defaultValues?.client_gender || ""}
                ...
                <div>
                  ...
                  <Controller
                    ...
                    control={control}
                    defaultValue={defaultValues?.client_martial_status || ""}
                ...
                <div>
                  ...
                  {loading && (
                    <div className="flex items-center mt-2 text-blue-500 text-xs">
                      <Loader className="animate-spin mr-2 text-xs" />
              ...
              <fieldset className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Controller
                    name="client_status"
                    control={control}
                    defaultValue={defaultValues?.client_status || ""}
