...
const SalaryAdvanceRepaymentDialog = ({
  isOpen,
  onClose,
  refetch,
  applicationId,
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axiosPrivate.post(
        `/salary-advance/applications/${applicationId}/repayments`,
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="sm:max-w-[420px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Outstanding balance: {Number(outstandingBalance).toLocaleString()}
          </DialogDescription>
          <DialogClose asChild>
            <button
          ...
          <div>
            ...
            <Input
              ...
              {...register("amount", {
                ...
                validate: (v) =>
                  Number(v) <= Number(outstandingBalance) ||
...
export default SalaryAdvanceRepaymentDialog;
