...
const EditSalaryAdvanceProductDialog = ({
  isOpen,
  onClose,
  refetch,
  defaultValues,
  ...
  useEffect(() => {
    ...
    setValue(
      "max_advance_percentage",
      defaultValues.max_advance_percentage ?? ""
    );
    setValue("fee_type", defaultValues.fee_type ?? "percent");
    setValue("fee_value", defaultValues.fee_value ?? "");
    setValue(
      "allow_multiple_active",
      defaultValues.allow_multiple_active ?? "no"
    );
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axiosPrivate.patch(
        `/settings/salary-advance/products/${defaultValues.id}`,
        payload,
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[520px]">
        <DialogHeader>
          <DialogTitle>Edit Salary Advance Product</DialogTitle>
          <DialogDescription>
            Update this salary advance product&apos;s configuration.
          </DialogDescription>
          <DialogClose asChild>
            <button
...
export default EditSalaryAdvanceProductDialog;
