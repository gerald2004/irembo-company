...
const LoanSingleScheduleRepayment = ({ isOpen, onClose, refetch, scheduleData }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[450px]">
        <DialogHeader>
          <DialogTitle>Loan Schedule Repayment</DialogTitle>
          <DialogDescription>
            Follow the steps to manually pay loan schedule.
          </DialogDescription>
          <DialogClose asChild>
            <button
...
export default LoanSingleScheduleRepayment;
