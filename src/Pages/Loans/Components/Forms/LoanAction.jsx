...
const LoanAction = ({ isOpen, onClose, refetch, actionType }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const payload = {
        ...
        action: actionType, // Example: approve, reject, disburse
    ...
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Please provide the required details for this loan action.
          </DialogDescription>
          <DialogClose asChild>
            <button
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          {/* Action Reason */}
          <div>
            <Label htmlFor="action_reason">Action Comment</Label>
            <Input
              id="action_reason"
              type="text"
              placeholder="Enter reason for this action"
              {...register("action_reason", { required: "Reason is required" })}
            />
            {errors.action_reason && (
          ...
          {/* Action Notes */}
          <div>
            <Label htmlFor="action_notes">Additional Notes</Label>
            <Textarea
              id="action_notes"
