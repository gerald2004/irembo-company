...
const UpdateLoanApplicationDialog = ({ isOpen, onClose, refetch, defaultValues }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await axiosPrivate.put("/loans/applications", payload, {
        signal: controller.signal,
      });
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>Update Loan Application</DialogTitle>
          <DialogDescription>
            Follow the steps to complete the update loan application.
          </DialogDescription>
          <DialogClose asChild>
            <button
...
export default UpdateLoanApplicationDialog;
