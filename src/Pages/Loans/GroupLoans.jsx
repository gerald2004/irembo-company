...
const GroupLoans = () => {
  ...
  const { data: applicationsCount } = useQuery({
    queryKey: ["group-loans-count-applications", extraFilters],
    queryFn: async () => {
  ...
  const { data: activeCount } = useQuery({
    queryKey: ["group-loans-count-active", extraFilters],
    queryFn: async () => {
  ...
  const { data: dueTodayCount } = useQuery({
    queryKey: ["group-loans-count-due-today", extraFilters],
    queryFn: async () => {
  ...
  const { data: overdueCount } = useQuery({
    queryKey: ["group-loans-count-overdue", extraFilters],
    queryFn: async () => {
        ...
        <div className="flex-1 space-y-4 p-0 pt-2">
          ...
          <Tabs defaultValue="active" className="space-y-4">
            ...
            <TabsContent value="applications" className="space-y-4">
              <GroupLoansApplicationsTable extraFilters={extraFilters} />
            </TabsContent>
            <TabsContent value="active" className="space-y-4">
              <GroupLoanActiveTable extraFilters={extraFilters} />
            </TabsContent>
            <TabsContent value="due_today" className="space-y-4">
              <GroupLoanActiveTable extraFilters={{ ...extraFilters, due_today: 1 }} />
            </TabsContent>
            <TabsContent value="overdue" className="space-y-4">
              <GroupLoanOverdueTable extraFilters={extraFilters} />
            </TabsContent>
          </Tabs>
        </div>
      </div>
